...
void task_1() {
	...
	{
		// x finds out if the lc is bigger than ascii 97 or smaller than ascii 129
		if (lc[i] >= 97 && lc[i] <= 129) {

			//when it finds that it's between these ascii numbers, they will convert them to uppercases, which is -32 exactly.
